...
- https://validator.w3.org/nu/?doc=https://MaejorS.github.io/project5/index.html
...
| --- | --- | --- | --- | --- |
| home | [index.html](https://github.com/MaejorS/project5/blob/main/home/templates/home/index.html) | Link (if applicable) | ![screenshot](documentation/validation/html-home-index.png) | Notes (if applicable) |
| templates | [404.html](https://github.com/MaejorS/project5/blob/main/templates/404.html) | Link (if applicable) | ![screenshot](documentation/validation/html-templates-404.png) | Notes (if applicable) |
| templates | [customer_profile.html](https://github.com/MaejorS/project5/blob/main/templates/checkout/customer_profile.html) | Link (if applicable) | ![screenshot](documentation/validation/html-templates-customer_profile.png) | Notes (if applicable) |
| templates | [product_detail.html](https://github.com/MaejorS/project5/blob/main/templates/products/product_detail.html) | Link (if applicable) | ![screenshot](documentation/validation/html-templates-product_detail.png) | Notes (if applicable) |
| templates | [product_list.html](https://github.com/MaejorS/project5/blob/main/templates/products/product_list.html) | Link (if applicable) | ![screenshot](documentation/validation/html-templates-product_list.png) | Notes (if applicable) |
...
| Directory | File | URL | Screenshot | Notes |
| --- | --- | --- | --- | --- |
| static | [base.css](https://github.com/MaejorS/project5/blob/main/static/css/base.css) | Link (if applicable) | ![screenshot](documentation/validation/css-static-base.png) | Notes (if applicable) |
...
| Directory | File | URL | Screenshot | Notes |
| --- | --- | --- | --- | --- |
| checkout | [admin.py](https://github.com/MaejorS/project5/blob/main/checkout/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/checkout/admin.py) | ![screenshot](documentation/validation/py-checkout-admin.png) | Notes (if applicable) |
| checkout | [forms.py](https://github.com/MaejorS/project5/blob/main/checkout/forms.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/checkout/forms.py) | ![screenshot](documentation/validation/py-checkout-forms.png) | Notes (if applicable) |
| checkout | [models.py](https://github.com/MaejorS/project5/blob/main/checkout/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/checkout/models.py) | ![screenshot](documentation/validation/py-checkout-models.png) | Notes (if applicable) |
| checkout | [tests.py](https://github.com/MaejorS/project5/blob/main/checkout/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/checkout/tests.py) | ![screenshot](documentation/validation/py-checkout-tests.png) | Notes (if applicable) |
| checkout | [urls.py](https://github.com/MaejorS/project5/blob/main/checkout/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/checkout/urls.py) | ![screenshot](documentation/validation/py-checkout-urls.png) | Notes (if applicable) |
| checkout | [views.py](https://github.com/MaejorS/project5/blob/main/checkout/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/checkout/views.py) | ![screenshot](documentation/validation/py-checkout-views.png) | Notes (if applicable) |
| home | [admin.py](https://github.com/MaejorS/project5/blob/main/home/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/home/admin.py) | ![screenshot](documentation/validation/py-home-admin.png) | Notes (if applicable) |
| home | [models.py](https://github.com/MaejorS/project5/blob/main/home/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/home/models.py) | ![screenshot](documentation/validation/py-home-models.png) | Notes (if applicable) |
| home | [tests.py](https://github.com/MaejorS/project5/blob/main/home/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/home/tests.py) | ![screenshot](documentation/validation/py-home-tests.png) | Notes (if applicable) |
| home | [urls.py](https://github.com/MaejorS/project5/blob/main/home/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/home/urls.py) | ![screenshot](documentation/validation/py-home-urls.png) | Notes (if applicable) |
| home | [views.py](https://github.com/MaejorS/project5/blob/main/home/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/home/views.py) | ![screenshot](documentation/validation/py-home-views.png) | Notes (if applicable) |
|  | [manage.py](https://github.com/MaejorS/project5/blob/main/manage.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/manage.py) | ![screenshot](documentation/validation/py--manage.png) | Notes (if applicable) |
| products | [admin.py](https://github.com/MaejorS/project5/blob/main/products/admin.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/products/admin.py) | ![screenshot](documentation/validation/py-products-admin.png) | Notes (if applicable) |
| products | [models.py](https://github.com/MaejorS/project5/blob/main/products/models.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/products/models.py) | ![screenshot](documentation/validation/py-products-models.png) | Notes (if applicable) |
| products | [tests.py](https://github.com/MaejorS/project5/blob/main/products/tests.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/products/tests.py) | ![screenshot](documentation/validation/py-products-tests.png) | Notes (if applicable) |
| products | [urls.py](https://github.com/MaejorS/project5/blob/main/products/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/products/urls.py) | ![screenshot](documentation/validation/py-products-urls.png) | Notes (if applicable) |
| products | [views.py](https://github.com/MaejorS/project5/blob/main/products/views.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/products/views.py) | ![screenshot](documentation/validation/py-products-views.png) | Notes (if applicable) |
| staffsale_portal | [settings.py](https://github.com/MaejorS/project5/blob/main/staffsale_portal/settings.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/staffsale_portal/settings.py) | ![screenshot](documentation/validation/py-staffsale_portal-settings.png) | Notes (if applicable) |
| staffsale_portal | [urls.py](https://github.com/MaejorS/project5/blob/main/staffsale_portal/urls.py) | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/MaejorS/project5/main/staffsale_portal/urls.py) | ![screenshot](documentation/validation/py-staffsale_portal-urls.png) | Notes (if applicable) |
...
Alternatively, an improved way to manage bugs is to use the built-in **[Issues](https://www.github.com/MaejorS/project5/issues)** tracker on your GitHub repository. This can be found at the top of your repository, the tab called "Issues".
...
[![GitHub issue custom search](https://img.shields.io/github/issues-search?query=repo%3AMaejorS%2Fproject5%20label%3Abug&label=bugs)](https://www.github.com/MaejorS/project5/issues?q=is%3Aissue+is%3Aclosed+label%3Abug)

I've used [GitHub Issues](https://www.github.com/MaejorS/project5/issues) to track and manage bugs and issues during the development stages of my project.

All previously closed/fixed bugs can be tracked [here](https://www.github.com/MaejorS/project5/issues?q=is%3Aissue+is%3Aclosed+label%3Abug).
...
[![GitHub issues](https://img.shields.io/github/issues/MaejorS/project5)](https://www.github.com/MaejorS/project5/issues)

Any remaining open issues can be tracked [here](https://www.github.com/MaejorS/project5/issues).
